...
<div class="min-h-screen bg-gray-50 flex items-center justify-center py-12 px-4">
    <div class="w-full max-w-2xl">
        <div class="text-center mb-8">
            ...
            <h1 class="text-2xl font-bold mt-4 text-gray-900">Creer un compte</h1>
            <p class="text-gray-500 text-sm mt-1">Inscription ouverte a tous</p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
            ...
            <form method="POST" action="{{ route('register.post') }}" class="space-y-5">
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1.5">Numero de telephone *</label>
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                        <select name="phone_country_code" required
                            ...
                            <optgroup label="Tous les indicatifs (+1 a +998)">
                        ...
                        <div class="sm:col-span-2">
                            <input type="tel" name="phone_local" value="{{ old('phone_local') }}" required
                                   ...
                                   class="w-full border border-gray-300 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                                   placeholder="Numero local (ex: 6 12 34 56 78)">
                        </div>
                    </div>
                </div>
                ...
                <p class="text-xs text-gray-500">* Champs obligatoires: prenom, nom, mail, numero de telephone.</p>
