...
return [
    ...
    'import' => [
        ...
        'zero_results_alert_threshold' => (int) env('ECARSTRADE_ZERO_RESULTS_ALERT_THRESHOLD', 3),
        'zero_results_alert_cooldown_minutes' => (int) env('ECARSTRADE_ZERO_RESULTS_ALERT_COOLDOWN_MINUTES', 60),   
        'reduce_auth_warning_noise' => filter_var(env('ECARSTRADE_REDUCE_AUTH_WARNING_NOISE', true), FILTER_VALIDATE_BOOLEAN),
        'auth_warning_throttle_seconds' => (int) env('ECARSTRADE_AUTH_WARNING_THROTTLE_SECONDS', 1800),
        'display_margin' => (float) env('ECARSTRADE_DISPLAY_MARGIN', env('ECARSTRADE_MARGIN_MIN', 2000)),
